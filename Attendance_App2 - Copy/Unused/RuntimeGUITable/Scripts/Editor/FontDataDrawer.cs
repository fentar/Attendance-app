...
namespace UnityUITable
{
	...
	/// Class copied from https://bitbucket.org/Unity-Technologies/ui/src/0651862509331da4e85f519de88c99d0529493a5/UnityEditor.UI/UI/PropertyDrawers/FontDataDrawer.cs?at=2018.3%2Fstaging&fileviewer=file-view-default
	/// We need to duplicate it just so we can override the SetHorizontalAlignment and SetVerticalAlignment because in the original one they only function if the FontData is in a Text object...

	[CustomPropertyDrawer(typeof(UnityUITable.FontData), true)]
	/// <summary>
	...
	public class FontDataDrawer : PropertyDrawer
	{
		...
		{
			VerticalTextAligment currentVerticalAligment = GetVerticalAlignment((TextAnchor)alignment.enumValueIndex);
			alignment.enumValueIndex = (int)GetAnchor(currentVerticalAligment, horizontalAlignment);
